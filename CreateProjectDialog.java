...
public class CreateUserStory extends JDialog {
	...
	private JTextField estDurationTextField;
	...
	public CreateUserStory() {
		...
		}
		{
			...
			JLabel lblNewLabel_7 = new JLabel("Est. Duration (Days):");
			panelBottom.add(lblNewLabel_7);

			estDurationTextField = new JTextField();
			panelBottom.add(estDurationTextField);
			estDurationTextField.setColumns(10);
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						us.setDuration(Integer.parseInt(estDurationTextField.getText()));
